...
function onclickButton_LeaveChat()
{
    ...
    //    切断音　ＯＮ    ////////////////////////////////////////////////////////////////
    　var music = new Audio('/vpsud002.mp3');
      music.play();
...
function setAnswerSDP( rtcPeerConnection, sessionDescription )
{
    ...
    rtcPeerConnection.setRemoteDescription( sessionDescription )
        ...
        //    着信状態のステータス表示    /////////////////////////////////////////////////
          document.getElementById("connect-sts").style.visibility="visible";
          document.getElementById("disconnect-sts").style.visibility="hidden";
        ...
        //    ナレーター　ＯＮ    ////////////////////////////////////////////////////////
        // var music = new Audio('/vpvoi001.mp3');
        // music.play();
